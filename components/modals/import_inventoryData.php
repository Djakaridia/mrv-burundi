...
<div class="modal fade" id="importDataInventoryModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addInventoryModal" aria-hidden="true">
...
<script>
    ...
    $(document).ready(function() {
        $('#importDataInventoryModal').on('shown.bs.modal', async function(event) {
            ...
            if(!dataInventoryId){
                ...
                $('#importDataInventoryModal').modal('hide');
            }
        });

        $('#importDataInventoryModal').on('hide.bs.modal', function() {
