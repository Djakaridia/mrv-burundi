                ...
                <div class="col-12 col-xl-10 col-xxl-8">
                    <div class="row justify-content-center align-items-center g-5">
                        ...
                        <div class="col-12 col-lg-5 text-center p-5">
                            <img class="img-fluid mb-6 w-50 w-lg-70 d-dark-none" src="./assets/img/spot-illustrations/403.png" alt="" />
                            <img class="img-fluid mb-6 w-50 w-lg-70 d-light-none" src="./assets/img/spot-illustrations/dark_403.png" alt="" />

                            <h2 class="text-body fw-bolder mb-3">Accès refusé!</h2>
                            <p class="text-body mb-5">Désolé, vous n'avez pas accès à cette page.
