                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="btn-reveal-trigger d-flex gap-2">
                            <button title="Voir les résultats" type="button" class="btn btn-sm btn-phoenix-primary text-nowrap fs-10 px-2 py-1" onclick="window.location.href = 'referentiels.php?id=<?php echo $ref_curr['id']; ?>';">
